...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    list($username_err, $password_err) = validateLogin($link, $_POST["email-username"], $_POST["password"]);
}
...
>
  <head>
    ...
    <title>Login Básico - Páginas | Sneat - Bootstrap 5 HTML Admin Template - Pro</title>
